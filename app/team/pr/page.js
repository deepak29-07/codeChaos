        ...
        <div className="flex flex-col items-center justify-center min-h-screen px-4 py-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-4xl">
                <div className="bg-[#333333] rounded-2xl p-6 text-center">
                    ...
                    <p className="text-gray-400 text-sm">PR Manager</p>
                </div>
                <div className="bg-[#333333] rounded-2xl p-6 text-center">
                    <div className="w-20 h-20 mx-auto mb-4 rounded-full bg-gray-600 flex items-center justify-center text-3xl">
                        👤
                    ...
                    <p className="text-gray-400 text-sm">Communications Lead</p>
                </div>
                <div className="bg-[#333333] rounded-2xl p-6 text-center">
                    <div className="w-20 h-20 mx-auto mb-4 rounded-full bg-gray-600 flex items-center justify-center text-3xl">
                        👤
                    ...
                    <p className="text-gray-400 text-sm">Outreach Coordinator</p>
                </div>
            </div>
